/*----------------------------------------------------------------------
hmd.h is an include file for a hybrid MPI+OpenMP MD program, hmd.c.
----------------------------------------------------------------------*/
#include <stdio.h>
#include <math.h>
#include "mpi.h"
...
NMAX = Manimum # of atoms per processor
...
thbk[3]: thbk[0|1|2] is the # of linked-list cells in the x|y|z
  direction that each thread is assigned.
----------------------------------------------------------------------*/
double al[3];
int n,nb,nglob;
